...
<img width="555" height="388" alt="image" src="https://github.com/user-attachments/assets/d2d92c39-0f12-4c32-9ac1-2ef9df356c66" />
...
⚙️ How It Works
Sensing: Flex sensors are mounted on a glove. When a finger bends, the resistance of the sensor changes proportionally.

Processing: This resistance change is converted into a voltage change. The Arduino reads this via its Analog Input Pins.

Action: The Arduino processes these inputs and generates PWM signals, triggering the servos to move the robotic fingers to the corresponding angle.
